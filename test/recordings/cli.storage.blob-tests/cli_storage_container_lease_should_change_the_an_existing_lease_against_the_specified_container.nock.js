...
nock('https://cliteststorage2874.blob.core.windows.net:443')
  ...
  'x-ms-request-id': '41452a60-0001-00a7-0cff-086027000000',
...
nock('https://cliteststorage2874.blob.core.windows.net:443')
  ...
  etag: '"0x8D3D71690D5CE36"',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '1a1d61eb-0001-0095-6eff-0838f7000000',
  'x-ms-version': '2015-04-05',
  'x-ms-lease-status': 'locked',
  'x-ms-lease-state': 'leased',
  'x-ms-lease-duration': 'infinite',
  date: 'Wed, 07 Sep 2016 12:00:32 GMT' });
 return result; },
function (nock) { 
var result = 
nock('https://cliteststorage2874.blob.core.windows.net:443')
  ...
  etag: '"0x8D3D71690D5CE36"',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': 'f7665952-0001-0047-24ff-0886af000000',
  'x-ms-version': '2015-04-05',
  date: 'Wed, 07 Sep 2016 12:00:32 GMT' });
 return result; }]];