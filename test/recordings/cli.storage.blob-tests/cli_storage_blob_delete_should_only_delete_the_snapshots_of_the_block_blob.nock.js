...
nock('https://cliteststorage2874.blob.core.windows.net:443')
  .delete('/storage-cli-blob-test/blockblobname695232365434740')
  .reply(202, "", { 'transfer-encoding': 'chunked',
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '36ea5089-0001-00e4-0eff-084ace000000',
...
nock('https://cliteststorage2874.blob.core.windows.net:443')
  ...
  server: 'Windows-Azure-Blob/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': 'f43b9bdb-0001-0081-72ff-08fb93000000',
  'x-ms-version': '2015-04-05',
  'x-ms-write-protection': 'false',
  'x-ms-lease-status': 'unlocked',
  'x-ms-lease-state': 'broken',
  'x-ms-blob-type': 'BlockBlob',
  date: 'Wed, 07 Sep 2016 12:02:57 GMT' });
 return result; }]];