...
nock('http://management.azure.com:443')
  ...
  expires: '-1',
  etag: 'W/"925bab70-76bb-45cc-bc94-d5325c918a86"',
  'x-ms-request-id': 'd104a587-34f7-4add-ac54-d7ca21b05385',
  'strict-transport-security': 'max-age=31536000; includeSubDomains',
  server: 'Microsoft-HTTPAPI/2.0, Microsoft-HTTPAPI/2.0',
  'x-ms-ratelimit-remaining-subscription-reads': '14997',
  'x-ms-correlation-request-id': 'edd8d2a9-4e13-482b-99b9-b1168031eef1',
  'x-ms-routing-request-id': 'WESTEUROPE:20170209T135537Z:edd8d2a9-4e13-482b-99b9-b1168031eef1',
  date: 'Thu, 09 Feb 2017 13:55:37 GMT',
  connection: 'close' });
 return result; },
function (nock) { 
var result = 
