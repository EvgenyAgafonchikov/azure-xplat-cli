...
nock('https://cliteststorage6387.file.core.windows.net:443')
  ...
  'x-ms-request-id': '7c192d78-001a-0018-5f00-097451000000',
...
nock('https://cliteststorage6387.file.core.windows.net:443')
  ...
  server: 'Windows-Azure-File/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '2111f283-001a-0101-0400-091e6c000000',
  'x-ms-version': '2015-04-05',
...
nock('https://cliteststorage6387.file.core.windows.net:443')
  ...
  etag: '"0x8D3D71723B45D8C"',
  server: 'Windows-Azure-File/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': 'b94b5f7d-001a-005b-3100-095eb8000000',
  'x-ms-version': '2015-04-05',
  'x-ms-share-quota': '20',
  date: 'Wed, 07 Sep 2016 12:04:37 GMT' });
 return result; },
...
nock('https://cliteststorage6387.file.core.windows.net:443')
  ...
  server: 'Windows-Azure-File/1.0 Microsoft-HTTPAPI/2.0',
  'x-ms-request-id': '7edd488f-001a-0102-2d00-091d6b000000',
  'x-ms-version': '2015-04-05',
  date: 'Wed, 07 Sep 2016 12:04:37 GMT' });
 return result; }]];